...
const Description = () => {
    return (
        <>
            ...
            <p>O evento acontecerá entre os <strong>dias 05 e 06 de junho de 2023</strong> no auditório do Centro Cultural <q>Pedro Alberto Tayano Filho</q>.</p>
            ...
            As inscrições são limitadas e serão abertas no <strong>dia 17 de maio de 2023</strong>, podendo ser realizadas no link abaixo.</p>
        </>
    )
}
